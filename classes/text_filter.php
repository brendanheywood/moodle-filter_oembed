...
if (class_exists('\core_filters\text_filter')) {
    class_alias('\core_filters\text_filter', 'filter_oembed_base_text_filter');
} else {
    class_alias('\moodle_text_filter', 'filter_oembed_base_text_filter');
}

/**
 *
 */
class text_filter extends \filter_oembed_base_text_filter {
